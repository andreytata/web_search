...
def test_bing_no_js():
    links = web_search.find_use_bing_no_js("naruto+ru")
    print("\n".join(links))

def test_bing_no_js_russian():
    links = web_search.find_use_bing_no_js(u"Наруто+Боруто")
    print("\n".join(links))
...
if __name__ == "__main__":
    print(u'\nFIND bing: u"naruto+ru"')
    test_bing_no_js()
    print(u'\nFIND bing: u"Наруто+Боруто"')
    test_bing_no_js_russian()
